...
export default function GetMyCenters() {
	...
	return (
		<div className='w-full px-4 mt-[150px]'>
			<div className='w-full flex justify-center'>
				<div className='grid gap-[25px] w-full max-w-[1280px] sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4'>
					<Link
						to={'/seo/addCenter'}
						className='flex flex-col justify-center items-center border-2 border-dashed border-gray-300 rounded-xl hover:border-gray-500 hover:scale-[1.02] cursor-pointer duration-300 p-4 hover:shadow-lg shadow-md min-h-[300px] dark:shadow-[0_0_20px_rgba(255,255,255,0.1)]'
					>
						<Plus size={36} className='text-gray-400 mb-2' />
						<p className='text-gray-500 font-medium'>
							{t("Yangi markaz qo'shing")}
						</p>
					</Link>
