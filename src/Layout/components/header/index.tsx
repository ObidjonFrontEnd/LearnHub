				...
				<div className='w-full mx-auto flex justify-between items-center  px-[10px]'>
					...
					<div className='flex gap-[10px]'>
						...
						<button onClick={toggleTheme}>
							...
							<div className="block md:hidden hover:text-[#D56A42] duration-[0.3s]" onClick={toggleMenu}>
							<Menu />
						</div>

						<select value={lang} onChange={(e)=>{changeLang(e.target.value)}} className='hidden md:block' >
						...
						<button className='relative overflow-hidden px-6 py-[10px] rounded-xl text-[#D56A42] border border-[#D56A42] font-semibold bg-transparent group transition-colors duration-300 cursor-pointer hidden md:block' onClick={()=>{navigate("/login")}}>
						...
						<button className='relative overflow-hidden px-6 py-[10px] rounded-xl text-white bg-[#D56A42] border border-[#D56A42] font-semibold  group transition-colors duration-300 cursor-pointer hidden md:block' onClick={()=>{navigate("/register")}}>
