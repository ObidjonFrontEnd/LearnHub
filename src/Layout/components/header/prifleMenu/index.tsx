 ...
 const getUserData = async (accessToken: string | null) => {
  ...
  return (
    <div className="relative inline-block text-left">
      ...
      >
        <div className="w-8 h-8 rounded-full group bg-gray-200 border border-purple-500 flex items-center justify-center overflow-hidden " ><img src={`${data?.data?.image === "default.jpg" ? (data?.data?.image): (`https://findcourse.net.uz/api/image/${data?.data?.image}`)}`} alt="user foto" /></div>
